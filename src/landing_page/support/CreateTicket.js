    ...
    return ( 
      ...
      <div className="row p-5 mt-5">
        ...
        <div className="col-4 p-5 mb-5">
            <h4 className="mb-4"><i className="fa-solid fa-circle-plus"></i> Account Opening</h4>
        ...
        <div className="col-4 p-5 mb-5">
            <h4 className="mb-4"><i className="fa-solid fa-user"></i> Your InvestIQ Account</h4>
        ...
        <div className="col-4 p-5 mb-5">
            <h4 className="mb-4"><i className="fa-solid fa-chart-simple"></i> Kite</h4>
        ...
        <div className="col-4 p-5 mb-5">
            <h4 className="mb-4"><i className="fa-solid fa-credit-card"></i> Funds</h4>
        ...
        <div className="col-4 p-5 mb-5">
            <h4 className="mb-4"><i className="fa-solid fa-terminal"></i> Console</h4>
        ...
        <div className="col-4 p-5 mb-5">
            <h4 className="mb-4"><i className="fa-solid fa-coins"></i> Coin</h4>
